...
class DesktopPet:
    ...
    def on_hover(self, event):
        ...
        if not self.showing_icons:
            self.hover_timer = self.master.after(1000, self.show_icons)  # 2秒后显示图标
    ...
    def on_leave(self, event):
        ...
        if self.hover_timer:
            ...
            self.hover_timer = None
        self.hide_timer = self.master.after(5000, self.hide_icons)  # 延迟3秒后隐藏图标
    ...
    def show_emotion_options(self):
        ...
        for i, emotion in enumerate(options):
            ...
            self.master.after(4000, btn.destroy)  # 延迟2秒后自动销毁选项按钮
    ...
    def show_emotion(self, emotion):
        ...
        # 3秒后恢复原始皮肤
        self.master.after(4000, self.restore_default_skin)

        # 2秒后隐藏情绪框
        self.master.after(3000, lambda: self.emotion_label.place_forget())
